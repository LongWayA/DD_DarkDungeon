...
var Timer = {
  ...
  tickMustTimeMs : 0,// время отведенное на один круг

  timeStartTickMs : 0,// фиксируем время начала тика
  timeEndTickMs : 0,// фиксируем время после тика
  timeBetweenEndMinStartTickMs : 0,// время тика	в это время идет расчет и отрисовка игры
  timeThreadSleepGameMs : 0,// время бездействия потока игры. мы все сделали и оставшееся время бездействуем
  ...
  //=============================================================================
     ...
     */
  //============================================================================
  updateTimeBeforeTick : function() : void {
 ...
 //=============================================================================
 ini_OUT : function(_ticksPerSecond : number) : void{
