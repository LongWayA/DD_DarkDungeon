...
var Frames = {
    ...
    drowEditorFrame: function () {
        Out.HTML5_Canvas_Primitive_drawRect("drowEditorFrame", Frames.EditorFrame.x0, Frames.EditorFrame.y0, Frames.EditorFrame.width, Frames.EditorFrame.height, 2, 'blue', 0);
    },
    //=============================================================================
    //=============================================================================
    // MapFrame
    drowMapFrame: function () {
        Out.HTML5_Canvas_Primitive_drawRect("drowMapFrame", Frames.MapFrame.x0, Frames.MapFrame.y0, Frames.MapFrame.width, Frames.MapFrame.height, 2, 'blue', 0);
    },
    //=============================================================================  
    //=============================================================================
    // TilesPanelFrame
    drowTilesPanelFrame: function () {
        Out.HTML5_Canvas_Primitive_drawRect("drowTilesPanelFrame", Frames.TilesPanelFrame.x0, Frames.TilesPanelFrame.y0, Frames.TilesPanelFrame.width, Frames.TilesPanelFrame.height, 2, 'blue', 0);
    },
    //=============================================================================  
    //=============================================================================
    // PrintFrame
    drowPrintFrameFrame: function () {
        Out.HTML5_Canvas_Primitive_drawRect("drowPrintFrameFrame", Frames.PrintFrame.x0, Frames.PrintFrame.y0, Frames.PrintFrame.width, Frames.PrintFrame.height, 2, 'blue', 0);
    },
    //=============================================================================  
}; //Frames
Frames.ini();
