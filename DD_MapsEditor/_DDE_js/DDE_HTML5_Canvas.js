...
HTML5_Canvas.ini_HTML5_Canvas = function(){
      ...
      HTML5_Canvas.context.strokeText ('Загрузка модулей.', 10, 80);//была надпись LOADING RESOURCES
      HTML5_Canvas.context.strokeText ('Modules loading', 10, 130);//была надпись LOADING RESOURCES
...
HTML5_Canvas.TestLoadedScripts.NAME = "Test loading Scripts";//
  ...
  HTML5_Canvas.TestLoadedScripts.testLoading = function(_nameScript) {
    ...
    HTML5_Canvas.context.strokeText (HTML5_Canvas.TestLoadedScripts.TEST_COUNT + ' Module ' + _nameScript + ' loaded', 
 ...
 HTML5_Canvas.TestLoadedScripts.testLoading ('DDE_HTML5_Canvas.js'); 
