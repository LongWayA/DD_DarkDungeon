...
UserInputMouse.clik = function(_mouse_X, _mouse_Y) {
     ...
     } else if ( ( _mouse_Y > EditorFrames.tilesPanelFrame_Ground_Y0) && (_mouse_Y < EditorFrames.tilesPanelFrame_Ground_Y_Max) ){

          //console.log("DD_UserInputMouse.js: По вертикали мы в зоне выбора тайлов уровня земля Y = " + _mouse_Y);
          UserInputMouse.clikMapGetTile(_mouse_X, _mouse_Y, EditorFrames.tilesPanelFrame_Ground_X0, EditorFrames.tilesPanelFrame_Ground_Y0, "GROUND"); 

     } else if ( ( _mouse_Y > EditorFrames.tilesPanelFrame_Item_Y0) && (_mouse_Y < EditorFrames.tilesPanelFrame_Item_Y_Max ) ){

          //console.log("DD_UserInputMouse.js: По вертикали мы в зоне выбора тайлов уровня предметы Y = " + _mouse_Y);
          UserInputMouse.clikMapGetTile(_mouse_X, _mouse_Y, EditorFrames.tilesPanelFrame_Item_X0, EditorFrames.tilesPanelFrame_Item_Y0, "ITEM"); 

     } else if ( ( _mouse_Y > EditorFrames.tilesPanelFrame_Monster_Y0) && (_mouse_Y < EditorFrames.tilesPanelFrame_Monster_Y_Max) ){

          //console.log("DD_UserInputMouse.js: По вертикали мы в зоне выбора тайлов уровня монстры Y = " + _mouse_Y);
          UserInputMouse.clikMapGetTile(_mouse_X, _mouse_Y, EditorFrames.tilesPanelFrame_Monster_X0, EditorFrames.tilesPanelFrame_Monster_Y0, "MONSTER"); 
...
UserInputMouse.clikMapSetTile = function(_mouse_X, _mouse_Y, _X0, _Y0) {
     ...
     let X0 =  SpritesMap.GROUNDS_MAX_COUNT *  Map.tile.width + EditorFrames.tilesPanelFrame_Ground_X0 + 20;
     let Y0 = EditorFrames.tilesPanelFrame_Ground_Y0;
