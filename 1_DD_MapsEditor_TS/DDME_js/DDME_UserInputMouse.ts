...
ini : function(){
     ...
     //----------------------------------------------------------------------------- 
     Out.HTML5_Canvas.Id_OUT.addEventListener('mousemove', (event : any) => {
   ...
   //-----------------------------------------------------------------------------     
     ...
     Out.HTML5_Canvas.Id_OUT.addEventListener('mousedown', (event : any) => {
...
//
//==============================================================================
clik : function(_mouse_X : number, _mouse_Y : number) {
...
//
//==============================================================================
clikMapSetTile : function(_mouse_X : number, _mouse_Y : number, _X0 : number, _Y0 : number) {
...
//==============================================================================
clikMapGetTile : function(_mouse_X : number, _mouse_Y : number,  _X0 : number, _Y0 : number, _layer : string) {
     ...
     if (trueLayer == true ){
         ...
         // console.log("DD_UserInputMouse.js: Out.EditorFrames.TilesPanelFrame.tile_SIZE_WIDTH = " +  Out.EditorFrames.TilesPanelFrame.tile_SIZE_WIDTH);
          ...
          if (clikMapGet_X < maxCount + 1) {
               ...
               Out.HTML5_Canvas.Primitive.drawRect("DDME_UserInputMouseEditor.js", j * Out.EditorFrames.TilesPanelFrame.tile_SIZE_WIDTH + _X0, _Y0, 
                    Out.EditorFrames.TilesPanelFrame.tile_SIZE_WIDTH, Out.EditorFrames.TilesPanelFrame.tile_SIZE_HEIGHT, 2, 'red', 0);
