...
NAME : "LoadFromServer",//
OKresponse : "",
LoadingMapsString : new Array(10000), // массив имен карт.
LoadingMapsInt    : new Array(10000), // массив ид чисел карт. по ним сортируем карты
...
//=============================================================================
//
mapStrigToDraw : function(_mapOneString : string) {
...
//=============================================================================
sortingLoadingMaps : function(_listLoadingMapsNotSorting : string) {
