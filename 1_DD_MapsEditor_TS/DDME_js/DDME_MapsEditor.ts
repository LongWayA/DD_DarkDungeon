...
var MapsEditor = {
  ...
  stopClick : false ,// нужен чтобы список карт выводился в текстовое поле только раз
...
let buttonSaveMapBr = <HTMLElement>document.getElementById("buttonSaveMapBr");//
...
let buttonLoadMapBr = <HTMLElement>document.getElementById("buttonLoadMapBr");//
...
let buttonResetMap = <HTMLElement>document.getElementById("buttonResetMap");//
...
let buttonSaveMapServ = <HTMLElement>document.getElementById("buttonSaveMapServ");//
...
let buttonLoadMapServ = <HTMLElement>document.getElementById("buttonLoadMapServ");//
...
let nameMapLoadingFromServerJ = <HTMLElement>document.getElementById("nameMapLoadingFromServer");//
...
/*
console.log('DD_MapsEditor.js: buttonLoadMapServ  Out.HTML5_Canvas_TestLoadedScripts = ' +  Out.HTML5_Canvas_TestLoadedScripts);//Out.LoadFromServer.NAME
  console.log('DD_MapsEditor.js: buttonLoadMapServ  Out.SaveInBrowser = ' +  Out.SaveInBrowser);//Out.LoadFromServer.NAME
  console.log('DD_MapsEditor.js: buttonLoadMapServ  Out.LoadFromBrowser = ' +  Out.LoadFromBrowser);//Out.LoadFromServer.NAME
  console.log('DD_MapsEditor.js: buttonLoadMapServ  Out.SaveInServer = ' +  Out.SaveInServer);//Out.LoadFromServer.NAME
  console.log('DD_MapsEditor.js: buttonLoadMapServ  Out.LoadFromServer = ' +  Out.LoadFromServer);//Out.LoadFromServer.NAME
  console.log('DD_MapsEditor.js: buttonLoadMapServ  Out.LoadFromScripts = ' +  Out.LoadFromScripts);//Out.LoadFromServer.NAME
  console.log('DD_MapsEditor.js: buttonLoadMapServ  Out.MapFrameDraw = ' +  Out.MapFrameDraw);//Out.LoadFromServer.NAME
  console.log('DD_MapsEditor.js: buttonLoadMapServ  Out.EditorFrameDraw = ' +  Out.EditorFrameDraw);//Out.LoadFromServer.NAME
  console.log('DD_MapsEditor.js: buttonLoadMapServ  Out.VisitCounter = ' +  Out.VisitCounter);//Out.LoadFromServer.NAME
*/