...
class Tile_for_load_Image_C {
  ...
  tile_Image_OUT : any;// содержит картинку для отображения на карте
  tile_path : string;//содержит путь по которому была загружена картинка
  tile_char : string;//содержит символ соответствующий картинке на карте
  tile_String : string;//содержит название картинки
...
var SpritesMap_2D = {
 ...
 //GROUNDS
  ...
  GROUND_STONE          : "a",//1 непробиваемый камень
  GROUND_SEND           : "b",//2 копаемый песок
  GROUND_FLOOR          : "c",//3 проходимый пол
  GROUND_WALL           : "d",//4 стена подземелья
  GROUND_WALL_FORTIFED  : "e",//5 укрепленная стена подземелья 
  GROUND_VEIN_GOLD      : "f",//6 золотая жила
  GROUND_VEIN_GEM       : "g",//7 драгоценный камень жила
 ...
 //MONSTERS
   ...
   MONSTERS_LICH     : "g",//7
   MONSTERS_MEDUSA   : "h",//8
   MONSTERS_MINOTAUR : "i",//9
   MONSTERS_GENIE    : "j",//10
   MONSTERS_FIGHTER  : "k",//11
   MONSTERS_GARGOYLE : "l",//12
   MONSTERS_SKELETON : "m",//13
   MONSTERS_TITAN    : "n",//14

  //SpritesMap_2D.tilesLoad[SpritesMap_2D.GROUNDS,SpritesMap_2D.GROUND_FLOOR].tile_Image_OUT;//_type, _index
  tilesLoad : new Array(5),// Массив двумерный содержит картинки-тайлы для отображения на карте. Доступ по типу и индексу
...
*/
  ...
  GroundsMapChars: new Map(),// для GROUNDS
  ItemsMapChars:  new Map(),// для ITEMS
  MonstersMapChars:  new Map(),// для MONSTERS

  // коллекции Map (по символу выдает имя тайла)
  GroundsMapString:  new Map(),// для GROUNDS
  ItemsMapString:  new Map(),// для ITEMS
  MonstersMapString:  new Map(),// для MONSTERS
...
// SpritesMap_2D.getTileSprite(SpritesMap_2D.GROUNDS,SpritesMap_2D.GROUND_FLOOR, true);
  //============================================================================
  getTileSprite : function(_type : number, _index: number, _indexIsChar = false) {
...
// SpritesMap_2D.getTileChar(SpritesMap_2D.GROUNDS,SpritesMap_2D.GROUND_FLOOR);
  //============================================================================
  getTileChar : function(_type : number, _index: number, _indexIsChar = false) {
...
// SpritesMap_2D.getTileString(SpritesMap_2D.GROUNDS,SpritesMap_2D.GROUND_FLOOR);
  //============================================================================
  getTileString : function(_type : number, _index: number, _indexIsChar = false) {
...
//============================================================================
  ...
  // get Height Sprite
  //============================================================================
  getHeightSprite : function(_type : number, _index: number) {
  ...
  // get Width Sprite
  //============================================================================
  getWidthSprite : function(_type : number, _index: number) {
  ...
  // get Left Sprite
  //============================================================================
  getLeftSprite : function(_type : number, _index: number, _middle: number) {
 ...
 // ini Image
  //============================================================================
  iniSprite : function(_type : number, _path : string){
