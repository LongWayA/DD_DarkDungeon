...
class Tile_for_Map_C {
  ...
  G_char : string ;//GROUNDS character
  I_char : string ;//ITEMS character
  M_char : string ;//MONSTERS character
...
var Map_2D = {
  ...
  widthMax_px : 0,// это размеры тайловой карты
  heightMax_px : 0,
...
loadMapArrayTile : function(_saveGrounds : string, _saveItems : string, _saveMonsters : string) {
