...
var TilesFrameDraw = {
 ...
 //=============================================================================
  ...
  /*
	 */
  //============================================================================
  drawSelectTiles : function(_lef : number) {

    let imageK ="";
   
    Out.HTML5_Canvas.context_OUT.clearRect( Out.EditorFrames.TilesPanelFrame.Ground_X0 ,
      Out.EditorFrames.TilesPanelFrame.Ground_Y0,(Out.SpritesMap_2D.GROUNDS_MAX_COUNT-1) * Out.EditorFrames.TilesPanelFrame.tile_SIZE_WIDTH, Out.EditorFrames.TilesPanelFrame.tile_SIZE_HEIGHT);

      Out.HTML5_Canvas.Primitive.drawRect( "DDME_TilesFrameDraw.js", Out.EditorFrames.TilesPanelFrame.Ground_X0 ,
      Out.EditorFrames.TilesPanelFrame.Ground_Y0,(Out.SpritesMap_2D.GROUNDS_MAX_COUNT-1) * Out.EditorFrames.TilesPanelFrame.tile_SIZE_WIDTH, Out.EditorFrames.TilesPanelFrame.tile_SIZE_HEIGHT, 1, 'green', 0);
...
/////////////////////////////////////////////////////////////////
    ...
    for (let j = 0; j < Out.SpritesMap_2D.GROUNDS_MAX_COUNT; j++) {
      ...
      //
      Out.HTML5_Canvas.Image.drawImage(imageK, j_1 * Out.EditorFrames.TilesPanelFrame.tile_SIZE_WIDTH + Out.EditorFrames.TilesPanelFrame.Ground_X0, 
        Out.EditorFrames.TilesPanelFrame.Ground_Y0, Out.EditorFrames.TilesPanelFrame.tile_SIZE_WIDTH, Out.EditorFrames.TilesPanelFrame.tile_SIZE_HEIGHT);
...
/////////////////////////////////////////////////////////////////
    ...
    for (let j = 0; j < Out.SpritesMap_2D.ITEMS_MAX_COUNT; j++) {
      ...
      //
      Out.HTML5_Canvas.Image.drawImage(imageK, j_1 * Out.EditorFrames.TilesPanelFrame.tile_SIZE_WIDTH + Out.EditorFrames.TilesPanelFrame.Item_X0, 
        Out.EditorFrames.TilesPanelFrame.Item_Y0, Out.EditorFrames.TilesPanelFrame.tile_SIZE_WIDTH, Out.EditorFrames.TilesPanelFrame.tile_SIZE_HEIGHT);
      ...
      //
      Out.HTML5_Canvas.Primitive.drawRect("DDME_TilesFrameDraw.js", j_1 * Out.EditorFrames.TilesPanelFrame.tile_SIZE_WIDTH + Out.EditorFrames.TilesPanelFrame.Item_X0, 
        Out.EditorFrames.TilesPanelFrame.Item_Y0, Out.EditorFrames.TilesPanelFrame.tile_SIZE_WIDTH, Out.EditorFrames.TilesPanelFrame.tile_SIZE_HEIGHT, 1, 'blue', 0);
    }
...
/////////////////////////////////////////////////////////////////
    ...
    for (let j = 0; j < Out.SpritesMap_2D.MONSTERS_MAX_COUNT; j++) {
      ...
      Out.HTML5_Canvas.Image.drawImage(imageK, j_1 * Out.EditorFrames.TilesPanelFrame.tile_SIZE_WIDTH + Out.EditorFrames.TilesPanelFrame.Monster_X0, 
        Out.EditorFrames.TilesPanelFrame.Monster_Y0, Out.EditorFrames.TilesPanelFrame.tile_SIZE_WIDTH, Out.EditorFrames.TilesPanelFrame.tile_SIZE_HEIGHT);
      ...
      Out.HTML5_Canvas.Primitive.drawRect("DDME_TilesFrameDraw.js", j_1 * Out.EditorFrames.TilesPanelFrame.tile_SIZE_WIDTH + Out.EditorFrames.TilesPanelFrame.Monster_X0, 
        Out.EditorFrames.TilesPanelFrame.Monster_Y0, Out.EditorFrames.TilesPanelFrame.tile_SIZE_WIDTH, Out.EditorFrames.TilesPanelFrame.tile_SIZE_HEIGHT, 1, 'blue', 0);
