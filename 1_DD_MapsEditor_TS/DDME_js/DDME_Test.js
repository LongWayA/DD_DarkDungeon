...
var Test = {
    ...
    testAll: function () {
        //DDME_HTML5_Canvas.js
        if (Out.HTML5_Canvas.isOk != "OK")
            console.log("DDME_Test.js:script DDME_HTML5_Canvas.js NOT OK!"); //
        ...
        //DDME_Pathes.js
        if (Out.Pathes.isOk != "OK")
            console.log("DDME_Test.js:script DDME_Pathes.js NOT OK!"); //
        ...
        if (Out.SpritesMap_2D.isOk != "OK")
            console.log("DDME_Test.js:script DDME_HTML5_SpritesMap_2D.js NOT OK!"); //
        ...
        if (Out.EditorFrames.isOk != "OK")
            console.log("DDME_Test.js:script DDME_EditorFrames.js NOT OK!"); //
        ...
        //DDME_Map_2D.js
        if (Out.Map_2D.isOk != "OK")
            console.log("DDME_Test.js:script DDME_Map_2D.js NOT OK!"); //
        ...
        if (Out.MapFrameDraw.isOk != "OK")
            console.log("DDME_Test.js:script DDME_MapFrameDraw.js NOT OK!"); //
        ...
        if (Out.TilesFrameDraw.isOk != "OK")
            console.log("DDME_Test.js:script DDME_TilesFrameDraw.js NOT OK!"); //
        ...
        if (Out.SaveInBrowser.isOk != "OK")
            console.log("DDME_Test.js:script DDME_SaveInBrowser.js NOT OK!"); //
        ...
        if (Out.LoadFromBrowser.isOk != "OK")
            console.log("DDME_Test.js:script DDME_LoadFromBrowser.js NOT OK!"); //
        ...
        if (Out.LoadFromScripts.isOk != "OK")
            console.log("DDME_Test.js:script DDME_LoadFromScripts.js NOT OK!"); //
        ...
        if (Out.SaveInServer.isOk != "OK")
            console.log("DDME_Test.js:script DDME_SaveInServer.js NOT OK!"); //
        ...
        if (Out.LoadFromServer.isOk != "OK")
            console.log("DDME_Test.js:script DDME_LoadFromServer.js NOT OK!"); //
        ...
        if (Out.EditorFrameDraw.isOk != "OK")
            console.log("DDME_Test.js:script DDME_EditorFrameDraw.js NOT OK!"); //
        ...
        if (Out.UserInputMouse.isOk != "OK")
            console.log("DDME_Test.js:script DDME_UserInputMouse.js NOT OK!"); //
        ...
        if (Out.VisitCounter.isOk != "OK")
            console.log("DDME_Test.js:script DDME_VisitCounter.js NOT OK!"); //
        ...
        //DDME_VisitCounter.js
        if (Out.MapsEditor.isOk != "OK")
            console.log("DDME_Test.js:script DDME_MapsEditor.js NOT OK!"); //
        //if(Out.VisitCounter.isOk == "OK") console.log("DDME_Test.js:script DDME_VisitCounter.js OK!");//
        //if(Out.VisitCounter.isOk != "OK")       alert("DDME_Test.js:script DDME_VisitCounter.js NOT OK!");//
    },
    //=============================================================================
