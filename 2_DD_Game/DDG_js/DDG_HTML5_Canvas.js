...
// 
 ...
 HTML5_Canvas.ITALIC_20PX_SANS_SERIF = 'italic 20px sans-serif'; 
 HTML5_Canvas.ITALIC_30PT_ARIAL = 'italic 30pt Arial'; 
 HTML5_Canvas.BOLD_30PX_SANS_SERIF = 'bold 30px sans-serif';

 HTML5_Canvas.WHITE = 'white';
 HTML5_Canvas.BLACK = 'black';
 HTML5_Canvas.RED   = 'red';
 HTML5_Canvas.GREEN = 'green';
 HTML5_Canvas.BLUE  = 'blue';

 HTML5_Canvas.LINE_WIDTH_1 = 1;
...
HTML5_Canvas.Primitive.NAME = "HTML5_Canvas.Primitive";//
 ...
 //============================================================================
 HTML5_Canvas.Primitive.clearRect = function(_left, _top, _width, _height) {
