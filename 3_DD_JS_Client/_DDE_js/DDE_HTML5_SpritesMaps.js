...
// Last modified -02.08.2022-02.01.2023
...
window.SpritesMap_2D = {};
  ...
  SpritesMap_2D.PATH_TO_MAPS ="DDE_images" ;//
...
//инициализируем массивы с картинками
  ...
  SpritesMap_2D.loadAllSprite = function() {
    ...
    SpritesMap_2D.iniSprite(SpritesMap_2D.ADVENTURES,SpritesMap_2D.PATH_TO_MAPS + "/adventures/advans_");
    SpritesMap_2D.iniSprite(SpritesMap_2D.GROUNDS,SpritesMap_2D.PATH_TO_MAPS + "/grounds/gr_");
    SpritesMap_2D.iniSprite(SpritesMap_2D.ITEMS,SpritesMap_2D.PATH_TO_MAPS + "/items/it_");
    SpritesMap_2D.iniSprite(SpritesMap_2D.MONSTERS,SpritesMap_2D.PATH_TO_MAPS + "/monsters/mons_");

    SpritesMap_2D.ini_tiles_char();
};
//============================================================================

HTML5_Canvas.TestLoadedScripts.testLoading ('DDE_HTML5_SpritesMaps.js'); 
