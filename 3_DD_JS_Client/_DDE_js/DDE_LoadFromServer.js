...
//LoadFromServer.storyLoadingMapsJ.focus();
    ...
    xhr.open("POST", "http://alphagameset.xyz/3_DD_DarkDungeon/2_DD_PHP_Server/DD_LoadMap.php");
    xhr.send(formData);
...
// 
 ...
 LoadFromServer.loadListMapsFromServer = function() {
    try {
            ...
            // отправим данные
            let xhr = new XMLHttpRequest();
            xhr.open("POST", "http://alphagameset.xyz/3_DD_DarkDungeon/2_DD_PHP_Server/DD_ListMap.php");
            //xhr.send(formData);
            xhr.send();
