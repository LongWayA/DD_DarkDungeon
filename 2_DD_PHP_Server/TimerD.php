...
class Timer{
    ...
    public $microtime_now;//Возвращает текущую метку времени Unix с микросекундами, строку (string) в формате "msec sec" 0.23254800 1659715073
    public $microtime_now_array;
    public $microtime_IDD;// получаем строку без разрывов. в начале часы потом секунды 165971507323254800
    ...
    public function microtime_nowSplit(){
         ...
         */
          ...
          $this->microtime_IDD = $this->microtime_now_array[3];
